...
<body>
	<div class="container">
		...
		<h1>CompuSystems - API Demo<span>Enroll Subject to DB</span></h1>
...
<script>
	...
	function authenticate(data){
		...
		$("#sources-div").fadeOut();
		$("#results-div").fadeIn();
			$.post('api.php', { imageData: data, method : "enroll", subject_id : $("#subject_id").val()}, 
